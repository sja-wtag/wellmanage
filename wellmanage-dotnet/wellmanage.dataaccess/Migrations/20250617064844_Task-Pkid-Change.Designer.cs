...
namespace wellmanage.data.Migrations
{
    ...
    [Migration("20250617064844_Task-Pkid-Change")]
    partial class TaskPkidChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wellmanage.domain.Entity.Project", b =>
                {
            ...
            modelBuilder.Entity("wellmanage.domain.Entity.ProjectTask", b =>
                {
            ...
            modelBuilder.Entity("EmployeeProject", b =>
                {
                    b.HasOne("wellmanage.domain.Entity.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("wellmanage.domain.Entity.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("wellmanage.domain.Entity.ProjectTask", b =>
                {
                    b.HasOne("wellmanage.domain.Entity.Employee", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("wellmanage.domain.Entity.Project", "Project")
                        .WithMany()
